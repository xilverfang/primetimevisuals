...
const projects = [
  ...
  { id: 7, title: 'After Dark', category: 'Event', year: '2026', duration: '00:45', description: 'A night of movement, music, and the electric moments between them.', image: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&w=1800&q=85' },
  { id: 8, title: 'The Night We Made', category: 'Event', year: '2025', duration: '00:48', description: 'The energy of a live audience distilled into sixty unforgettable seconds.', image: 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=1800&q=85' },
  { id: 9, title: 'In Full Colour', category: 'Event', year: '2026', duration: '00:42', description: 'A vivid record of culture, connection, and collective celebration.', image: 'https://images.unsplash.com/photo-1527529482837-4698179dc6ce?auto=format&fit=crop&w=1800&q=85' },
  { id: 17, title: 'Main Stage', category: 'Event', year: '2026', duration: '00:46', description: 'The scale, sound, and human energy of a night built to be remembered.', image: 'https://images.unsplash.com/photo-1506157786151-b8491531f063?auto=format&fit=crop&w=1800&q=85' },
